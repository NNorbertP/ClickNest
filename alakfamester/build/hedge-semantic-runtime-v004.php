<?php
/**
 * AF Hedge semantic parity runtime v004
 ...
 *
 * v004 intentionally does NOT label #ajanlatkeres as a region until a fresh DOM
 * proves one complete target root owns the full source form section (intro + form).
 */
add_action('wp_footer', function () {
    ...
    ?>
<script id="af-hedge-semantic-parity-v004">
(function () {
  'use strict';
  ...
  function fixForm() {
    ...
    if (form) {
      ...
      if (directCall) {
        form.setAttribute('aria-describedby', ensureId(directCall, 'af-form-direct-call'));
      }
    }
